...
@Check(type = Type.AIM, var = "Penguin", alias = "Heuristic:Rotation/GCD.3!Modulo")
@Drop(decay = 20)
public class AimPenguin extends ComplexRotationCheck  {

    public AimPenguin(final PlayerData data, final CheckInformation info) {
        super(data, info);
    }
    ...
    public void handleRotation(final PlayerRotation from, final PlayerRotation to) {
        ...
        check: {
             ...
             */
            final boolean enclosesYaw = data.sensitivity.isEnclosesYaw();
            final boolean enclosesPitch = data.sensitivity.isEnclosesPitch();
             ...
             */
            final float distanceYaw = data.sensitivity.getDistanceYaw();
            final float distancePitch = data.sensitivity.getDistancePitch();
            ...
            if (distanceYaw > 1e-05 && distancePitch > 1e-05) {
                if (buffer++ > 2.F) {
                    this.log(
