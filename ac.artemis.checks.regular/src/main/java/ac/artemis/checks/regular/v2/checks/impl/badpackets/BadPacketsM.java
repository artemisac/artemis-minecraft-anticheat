...
@Check(type = Type.BADPACKETS, var = "M", threshold = 1)
public class BadPacketsM extends ArtemisCheck implements PacketHandler {

    private Long lastFlying;
    private long lastMovePacket;
    private double vl;

    public BadPacketsM(final PlayerData data, final CheckInformation info) {
        super(data, info);
    }
