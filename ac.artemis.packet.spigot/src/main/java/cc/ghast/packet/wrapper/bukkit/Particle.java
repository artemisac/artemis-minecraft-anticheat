...
public enum Particle {
    ...
    private Particle(String particleNameIn, int particleIDIn, boolean p_i46011_5_, int argumentCountIn)
    {
    ...
    private Particle(String particleNameIn, int particleIDIn, boolean p_i46012_5_)
    {
     ...
     */
    public static Particle getParticleFromId(int particleId) {
    ...
    static {
        ...
        for (Particle enumparticletypes : values()) {
