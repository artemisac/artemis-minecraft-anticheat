...
public class BlockFarm extends Block {
    ...
    public BlockFarm(final NaivePoint location, final EnumFacing direction) {
        super(NMSMaterial.FARMLAND, location, direction);
    }

    @Override
    public List<BoundingBox> getBoundingBox(final ArtemisWorld world) {
        return Collections.singletonList(
                getFromPoint(location, 0.0F, 0.0F, 0.0F, 1.0F, 0.9375F, 1.0F)
        );
    }
}
