...
public enum EnumFacing {
    ...
    EnumFacing(final int indexIn, final int oppositeIn, final int horizontalIndexIn, final String nameIn,
               final EnumFacing.AxisDirection axisDirectionIn, final EnumFacing.Axis axisIn, final Vec3i directionVecIn) {
        this.index = indexIn;
