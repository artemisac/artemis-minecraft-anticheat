package ac.artemis.core.v4.utils.http;
...
public class HTTPRequest {
    public static final ExecutorService HTTP_SERVICE = Threading.getOrStartService("artemis-debug-service");
    ...
    private String contentData = "text/plain";
    private Proxy proxy;
    ...
    /**
     * Sets post processor to send to the web server
     */
    ...
    /**
     * Used to define the type of content being sent to the server
     */
    ...
    private void setup() throws Exception {
        ...
        connection.addRequestProperty("Content-Type", contentData);
