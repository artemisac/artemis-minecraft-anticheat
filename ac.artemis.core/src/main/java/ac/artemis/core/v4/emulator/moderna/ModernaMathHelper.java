...
public class ModernaMathHelper {
   ...
   public static double getMin(BoundingBox box, Direction.Axis axis) {
      return axis.getCoordinate(box.minX, box.minY, box.minZ);
   }

   public static double getMax(BoundingBox box, Direction.Axis axis) {
      return axis.getCoordinate(box.maxX, box.maxY, box.maxZ);
   }
