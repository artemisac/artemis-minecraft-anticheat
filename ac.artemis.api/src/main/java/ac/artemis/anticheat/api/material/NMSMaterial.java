...
public enum NMSMaterial {
    ...
    ACACIA_DOUBLE_SLAB(4,"WOOD_DOUBLE_STEP"),
    ACACIA_STAIRS,
    ...
    BIRCH_DOUBLE_SLAB(3, "WOOD_DOUBLE_STEP"),
    ...
    DARK_OAK_SLAB(5, "WOOD_STEP", "WOODEN_SLAB"),
    DARK_OAK_DOUBLE_SLAB(5, "WOOD_DOUBLE_STEP"),
    DARK_OAK_STAIRS,
    ...
    JUNGLE_DOUBLE_SLAB(3, "WOOD_DOUBLE_STEP"),
    ...
    OAK_SLAB("WOOD_STEP", "WOODEN_SLAB"),
    OAK_DOUBLE_SLAB("WOOD_DOUBLE_STEP"),
    ...
    RED_SANDSTONE_DOUBLE_SLAB("DOUBLE_STONE_SLAB2"),
    ...
    SANDSTONE_DOUBLE_SLAB(1, "DOUBLE_STEP"),
    SANDSTONE_STAIRS,
    SANDSTONE_WALL,
    SCAFFOLDING(0, 14),
    SCUTE(13),
    ...
    SPRUCE_DOUBLE_SLAB(1, "WOOD_DOUBLE_STEP"),
    ...
    STONE_DOUBLE_BRICK_SLAB(4, "DOUBLE_STEP"),
     ...
     * @since 1.0.0
     */
    private static final Map<String, NMSMaterial> NAME_CACHE = new HashMap<>();
    ...
    NMSMaterial(int data, int version,  String... legacy) {
        ...
        if (mat == null) {
            Server.v().getConsoleSender().sendMessage("[Warning] Failed to find binding for " + name()
                    + " (aliases: " + Arrays.toString(legacy) + ")");
        }
    ...
    private static NMSMaterial requestOldNMSMaterial( String name, byte data) {
        ...
        NMSMaterial cache = NAME_CACHE.get(holder);
     ...
     *
     * @param version Supports {@link Server#getVersion()}, { Server#getBukkitVersion()} and normal formats such as "1.14"
    ...
    public String toString() {
        return caps(this.name().replace('_', ' ').toLowerCase(Locale.ENGLISH));
    }

    private String caps(final String str) {
        if (str.equals("")) {
            return str;
        }
    ...
    public ItemStack parseItem() {
        ...
        return Data.ISFLAT
                ? Minecraft.v().createItemStack(material)
                : Minecraft.v().createItemStack(material, 1, this.data);
    }
    ...
    private static final class Data {
        ...
        private static final int VERSION = Integer.parseInt(
                getMajorVersion(Server.v().getVersion()).substring(2));
        /**
