 ...
 * Artemis © 2021
 */
public class ModernMoveWithHeadingProvider implements MoveWithHeadingProvider {
    ...
    public ModernMoveWithHeadingProvider(ProtocolVersion version) {
    ...
    public TransitionData moveWithHeading(TransitionData heading) {
        ...
        final boolean sprint = heading.poll(EntityAttributes.LAST_SPRINT);
        ...
        if (water && !flying) {
            ...
            final float slipperiness = heading.getFrictionAtBB(0.5000001D);
            final float frictionFactor = ground ? slipperiness * 0.91F : 0.91F;

            // This is the odd value "f" is in the formula.
            final float drag = 0.21600002F / (slipperiness * slipperiness * slipperiness);
            ...
            // Debug purposes
            heading.setMaxMotionX(heading.getMotionX());
            heading.setMaxMotionY(heading.getMotionY());
            heading.setMaxMotionZ(heading.getMotionZ());
            ...
            return heading.addAction(new OutputAction() {
                ...
                public void accept(TransitionData output) {
                    ...
                    final boolean collided = (output.isCollidedHorizontally() || output.isLastCollidedHorizontally())
                            && deltaY > 0.1175D; // DO NOT REMOVE, MAGIC VALUE.
